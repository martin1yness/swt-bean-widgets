package com.magnetstreet.swt.beanwidget.datagrid2.reflective;
 ...
 * @since 5/5/11
 */
public abstract class ReflectiveDataGrid<T> extends AbstractDataGrid<T> {
    public ReflectiveDataGrid(Composite composite, int i) {
        super(composite, i);
    }
