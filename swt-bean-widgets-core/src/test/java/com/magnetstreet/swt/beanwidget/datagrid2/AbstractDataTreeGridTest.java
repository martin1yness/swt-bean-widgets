...
public class AbstractDataTreeGridTest {
    ...
    public void createImaginaryTreeGrid() {
        ...
        given(dataTreeGrid.compareTreeItemToBean((TreeItem)any(), (Comparable)any())).willCallRealMethod();
    ...
    @Test public void testSetTopBean_beanNotFound_doNothing() {
        ...
        verify(tree, new Times(0)).setTopItem((TreeItem)any());
    }
    ...
    @Test public void testRecursiveGetTreeItems_extraItemWithNullData_beanComparisonSkipped() {
        ...
        given(dataTreeGrid.recursiveGetTreeItems(eq(false), (TreeItem[])anyVararg(), anyVararg())).willCallRealMethod();
    ...
    @Test public void testRecursiveGetTreeItems_allVisibleItemsWithEmptyBeanList_everyVisibleTreeItemReturned() {
        ...
        given(treeItemB.getExpanded()).willReturn(false);
        given(treeItemC.getExpanded()).willReturn(false);
        given(dataTreeGrid.recursiveGetTreeItems(eq(true), (TreeItem[])anyVararg(), anyVararg())).willCallRealMethod();
    ...
    @Test public void testUncheckAll_allItemsAreUnChecked() {
        ...
        given(dataTreeGrid.recursiveGetTreeItems(eq(true), (TreeItem[])anyVararg(), eq(null))).willReturn(list);
    ...
    @Test public void testCheckBeans_givenEmptySet_checkNothing() {
        ...
        verify(dataTreeGrid, new Times(0)).recursiveGetTreeItems(anyBoolean(), (TreeItem[])anyVararg(), anyVararg());
    ...
    @Test public void testCheckBeans_givenRootOnlyBeans_checkRootTreeItemsNotExpandedChildren() {
        given(treeItemC.getExpanded()).willReturn(true);
        willCallRealMethod().given(dataTreeGrid).checkBeans(anyCollection());
        given(dataTreeGrid.recursiveGetTreeItems(anyBoolean(), (TreeItem[])anyVararg(), anyVararg())).willCallRealMethod();
    ...
    @Test public void testSelectAll_selectionCreatedWithAllVisible() {
        ...
        given(dataTreeGrid.recursiveGetTreeItems(eq(true), (TreeItem[])anyVararg(), eq(null))).willReturn(expandedItems);
    ...
    @Test public void testRecursiveGenerateChildrenTreeNodes_singlePropertyNoChain_noChildrenOfChildren() {
        given(dataTreeGrid.recursiveGenerateChildrenTreeNodes((TreeNode)any(), anyString())).willCallRealMethod();
