...
/**
 * OrderReflectiveDataTableGrid
 *
 * @author Martin Dale Lyness <martin.lyness@gmail.com>
 * @since 5/5/11
 */
public class OrderReflectiveDataTableGrid extends ReflectiveDataTableGrid<Order> {
    public AtomicInteger discountTotalSaveCount = new AtomicInteger(0);

    public OrderReflectiveDataTableGrid(Composite composite, int i) {
        super(composite, i);
    }
