 ...
 * @since 5/5/11
 */
public class OrderReflectiveWithFiltersWindow extends ApplicationWindow {
    ...
    protected Control createContents(Composite parent) {
...

        {
            ...
            orderReflectiveDataGrid.setLayoutData(fd);
        }

        bindFilters();
        applyEventListeners();
        orderReflectiveDataGrid.setBeans(orders);
        orderReflectiveDataGrid.refresh();
    ...
    protected void bindFilters() {
        orderReflectiveDataGrid.bindFilter("id", new Callable<String>() {
            @Override public String call() throws Exception {
                return ".*"+orderIdFilterText.getText()+".*";
            }
        });
        orderReflectiveDataGrid.bindFilter("items", new Callable<String>() {
            @Override public String call() throws Exception {
                return ".*"+itemFilterText.getText()+".*";
            }
        });
        orderReflectiveDataGrid.bindFilter("discountTotal", new Callable<String>() {
            @Override public String call() throws Exception {
        ...
        orderReflectiveDataGrid.bindFilter("totalCost", new Callable<String>() {
            @Override public String call() throws Exception {
        ...
        orderReflectiveDataGrid.bindFilter("paid", new Callable<String>() {
            @Override public String call() throws Exception {
